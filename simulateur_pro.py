...
if st.session_state.paiement_reussi:
    ...
    def generer_contenu_riche(age, patrimoine, epargne, rendement):
        # Contenu pré-généré ultra-détaillé pour garantir des pages denses
    ...
    # Fonction de création du PDF ULTRA-RICHE
    def creer_pdf_riche(age, patrimoine, epargne, rendement):
        ...
        # ==========================================
        # PAGE 3 : SYNTHÈSE ET TABLEAUX
        # ==========================================
        story.append(Paragraph("PARTIE 1 : ANALYSE APPROFONDIE DE LA SITUATION PATRIMONIALE ACTUELLE", style_section))
        ...
        t = Table(tableau_donnees, colWidths=[150, 100, 200])
        t.setStyle(TableStyle([
            ('BACKGROUND', (0,0), (2,0), colors.HexColor('#004B87')),
        ...
        for para in paragraphes:
            ...
            if "PARTIE" in txt and "ANNEXE" not in txt:
        ...
        En synthèse, voici les 5 piliers de votre stratégie patrimoniale :

        1. Diversification : Répartition optimale entre actions, obligations, immobilier et liquidités
        2. Fiscalité : Utilisation du trio PEA/Assurance-Vie/PER pour minimiser l'impôt
        3. Sécurité : Constitution d'un matelas de précaution et protection du capital
        ...
        story.append(Spacer(1, 30))
        story.append(Paragraph("PROCHAINES ÉTAPES", style_section))
        etapes = """
        1. Prendre contact avec un Conseiller en Investissements Financiers (CIF) dans les 15 jours
        2. Ouvrir un PEA et une Assurance-Vie dans les 30 jours
        3. Constituer l'épargne de précaution dans les 3 mois
        4. Planifier le premier investissement immobilier dans les 6 mois
        5. Organiser la première révision annuelle de la stratégie
        """
        story.append(Paragraph(etapes, style_corps))
        ...
        Il ne constitue pas un conseil en investissement personnalisé au sens de la réglementation en vigueur. Toute décision 
        financière doit être prise après consultation d'un professionnel habilité (CIF, CGP, etc.).
        
        Les projections présentées sont basées sur des hypothèses de rendement et ne peuvent être garanties. 
        Les performances passées ne préjugent pas des performances futures.
        
        Conformément au RGPD, vos données sont traitées de manière confidentielle et ne sont pas conservées après la génération du rapport.
