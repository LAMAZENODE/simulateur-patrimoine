...
if st.session_state.paiement_pdf_ok:
    st.markdown("---")
    st.success("Paiement validé ! Votre rapport de 15 pages est prêt.")
    ...
    def generer_analyse_ia(client_ia_instance, age, patrimoine, epargne, rendement):
        ...
        try:
            ...
            return reponse.text if reponse.text else "Erreur : Le contenu retourné par l'IA est vide."
        except Exception as e:
    ...
    def creer_pdf(texte_ia, age, patrimoine, epargne, rendement):
        ...
        sommaire_data = [
            ...
            ["4. Annexes techniques et fiches réglementaires (Guides A à E)", "Page 12"],
        ...
        # PAGES 4 & 5 : TABLEAU ÉVOLUTION FINANCIÈRE
