...
def creer_pdf(texte_ia, age, patrimoine, epargne, rendement):
    ...
    annexes_pro = [
        ...
        ("D", "L'Immobilier de Rendement (Pierre-Papier / SCPI)", "Les Sociétés Civiles de Placement Immobilier permettent d'investir dans l'immobilier tertiaire dès quelques cents d'euros. Elles distribuent des revenus réguliers sous forme de loyers sans aucune contrainte de gestion."),
    ...
    signature_data = [
        [Paragraph("<b>Signature de l'Expert IA</b>", style_corps), Paragraph("<b>Signature du Client</b>", style_corps)],
